...
Route::get('/talent-register', 'homeController@apply')->name('homapply');
...
Route::get('admin/bootcamp/class', 'bootcampController@getIndex')->name('class.index');
Route::post('admin/bootcamp/class', 'bootcampController@postIndex')->name('class.postindex');

Route::post('admin/bootcamp/class/new', 'bootcampController@postNew');
Route::post('admin/bootcamp/class/newmateri', 'bootcampController@postNewMateri');
Route::post('admin/bootcamp/class/delete', 'bootcampController@postDelete');

Route::get('admin/bootcamp/class/editclass/{id}', 'bootcampController@getEdit');
Route::post('admin/bootcamp/class/editclass/{id}', 'bootcampController@postEdit')->name('post.edit');

Route::get('admin/bootcamp/materi', 'bootcampController@materiIndex')->name('materi.index');
Route::get('admin/bootcamp/materi/create', 'bootcampController@materiCreate')->name('materi.create');
Route::post('admin/bootcamp/materi/addmainmateri','bootcampController@materiStore')->name('materi.store');
Route::get('admin/bootcamp/materi/editmainmateri/{id}','bootcampController@materiEdit')->name('materi.edit');
Route::put('admin/bootcamp/materi/updatemainmateri','bootcampController@materiUpdate')->name('materi.update');
Route::post('admin/bootcamp/materi/deletemainmateri/{id}','bootcampController@materiDelete')->name('materi.delete');
Route::post('admin/bootcamp/materi/addsubmateri','bootcampController@submateriStore')->name('submateri.store');
Route::get('admin/bootcamp/materi/editsubmateri/{id}','bootcampController@submateriEdit')->name('submateri.edit');
Route::put('admin/bootcamp/materi/updatesubmateri/{id}','bootcampController@submateriUpdate')->name('submateri.update');
Route::post('admin/bootcamp/materi/deletesubmateri/{id}','bootcampController@submateriDelete')->name('submateri.delete');
Route::post('admin/bootcamp/materi/addsoal', 'bootcampController@addSoal')->name('soal.add');
Route::get('admin/bootcamp/materi/editsoal/{id}','bootcampController@editSoal')->name('soal.edit');
Route::put('admin/bootcamp/materi/updatesoal/{id}','bootcampController@upSoal')->name('soal.update');
Route::post('admin/bootcamp/deletesoal/{id}','bootcampController@delSoal')->name('soal.delete');
Route::get('admin/bootcamp/faq', 'bootcampController@faqIndex')->name('faq.index');
Route::post('admin/bootcamp/addfaq','bootcampController@faqStore')->name('faq.store');
Route::get('admin/bootcamp/editfaq/{id}','bootcampController@faqEdit')->name('faq.edit');
Route::put('admin/bootcamp/updatefaq/{id}','bootcampController@faqUpdate')->name('faq.update');
Route::post('admin/bootcamp/deletefaq/{id}','bootcampController@faqDelete')->name('faq.delete');
Route::get('admin/bootcamp/masterdata', 'bootcampController@fasilitasIndex')->name('bmaster.index');
Route::post('admin/bootcamp/addfasilitas','bootcampController@fasilitasStore')->name('fasilitas.store');
Route::get('admin/bootcamp/editfasilitas/{id}','bootcampController@fasilitasEdit')->name('fasilitas.edit');
Route::put('admin/bootcamp/updatefasilitas/{id}','bootcampController@fasilitasUpdate')->name('fasilitas.update');
Route::post('admin/bootcamp/deletefasilitas/{id}','bootcampController@fasilitasDelete')->name('fasilitas.delete');
Route::post('admin/bootcamp/addicon','bootcampController@iconStore')->name('icon.store');
Route::get('admin/bootcamp/editicon/{id}','bootcampController@iconEdit')->name('icon.edit');
Route::put('admin/bootcamp/updateicon/{id}','bootcampController@iconUpdate')->name('icon.update');
Route::post('admin/bootcamp/deleteicon/{id}','bootcampController@iconDelete')->name('icon.delete');
Route::post('admin/bootcamp/addlocation','bootcampController@locationStore')->name('location.store');
Route::get('admin/bootcamp/editlocation/{id}','bootcampController@locationEdit')->name('location.edit');
Route::put('admin/bootcamp/updatelocation/{id}','bootcampController@locationUpdate')->name('location.update');
Route::post('admin/bootcamp/deletelocation/{id}','bootcampController@locationDelete')->name('location.delete');
Route::get('admin/bootcamp/alumni', 'bootcampController@alumni')->name('alumni.index');
Route::get('admin/bootcamp/alumni/all', 'bootcampController@AlumniIndex')->name('alumni.all');
Route::post('admin/bootcamp/addalumni', 'bootcampController@addAlumni')->name('alumni.add');
Route::get('admin/bootcamp/editalumni/{id}', 'bootcampController@editAlumni')->name('alumni.edit');
Route::put('admin/bootcamp/updatealumni/{id}','bootcampController@upAlumni')->name('alumni.update');
Route::get('/deletealumni/', 'bootcampController@delAlumni')->name('alumni.delete');
Route::get('admin/bootcamp/alumni/move', 'bootcampController@move')->name('alumni.move');
