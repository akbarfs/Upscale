...
<body>
    ...
    <nav class="menu-classic menu-fixed menu-one-page align-right @yield('menu_class')" data-menu-anima="fade-bottom"
            ...
            <div class="menu-cnt">
                ...
                <div class="menu-right">
                    ...
                    <ul class="lan-menu">
                        <li class="dropdown">
                            @if ( isset($_GET['lang']) && $_GET['lang'] == 'en')
                            <a href="{{Request::url()}}?lang=en"><img src="{{url('template/upscale/media/en.png')}}"
                                    alt="" />&nbsp EN </a>
                            @else
                            <a href="{{Request::url()}}?lang=id"><img src="{{url('template/upscale/media/id.png')}}"
                                    alt="" />&nbsp ID </a>
                            @endif

                            <ul>
                                <li><a href="{{Request::url()}}?lang=id"><img
                                            src="{{url('template/upscale/media/id.png')}}" alt="" />ID</a></li>

                                <li><a href="{{Request::url()}}?lang=en"><img
                                            src="{{url('template/upscale/media/en.png')}}" alt="" />EN</a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            function regMember() {
                ...
                $(".loadRegTalent").html(
                    "<div class='loading loadmiddle'><img src='{{url('template/upscale/media/loading.gif')}}'><br>Please wait.. </div>"
                    ).load("{{url('register/talent')}}");
            }
        ...
        $(document).ready(function () {
            function loadInquiry() {
                $(".req-inquiry-modal").html(
                    "<div class='loading loadmiddle'><img src='{{url('template/upscale/media/loading.gif')}}'><br>Please wait.. </div>"
                    ).load("{{url('load-inquiry-form').param()}}");
            }
