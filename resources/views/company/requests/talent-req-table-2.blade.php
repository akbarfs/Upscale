        ...
        <table class="table table-striped mb-4">
            ...
            <tbody id="container">
                ...
                <tr>
                    ...
                    <?php $result = substr($talent->talent->talent_name, 0, 1) . preg_replace('/[^@]/', '*', substr($talent->talent->talent_name, 1));?>
                    ...
                    <td style="max-width: 250px">
                        @foreach ( $talent->talent->talent_skill()->get() as $row )
                        <?php 
                    ...
                    <td class="text-center">
                        @if (!empty($talent->talent->talent_lastest_salary))
                        @php
                        $gaji = (int)preg_replace('/[^0-9]/', '', $talent->talent->talent_lastest_salary);
                        @endphp
                        @currency($gaji)
                        @else
                        -
                    ...
                    <td>
                        @if (!empty($talent->talent->talent_salary))
                        @php
                           $expetasi = (int)preg_replace('/[^0-9]/', '', $talent->talent->talent_salary);
                        @endphp
                        @currency($expetasi)
                        @else
                        -
