                                ...
                                <table id="req-table" class="table table-striped table-bordered">
                                    ...
                                    @foreach($all as $request) 
                                        <tr>
                                            ...
                                            <td><a href="#" data-id="{{$request->request_id}}" type="button" class="btn btn-primary btn-xs detail-req"><i class="fa fa-eye"></i></a>
                                            <a href="#" data-id="{{$request->request_id}}" type="button" class="btn btn-warning btn-xs edit-req"><i class="fa fa-edit"></i></a></center></td>
...
$(document).on('click', '.detail-req', function() { 
    ...
    $.ajax({
        ...
        {
            $('.modal-body #comp-name').html(data.company_name);
...
var req_table=$('#req-table').DataTable({
        autoWidth:false,
        filter:true,
        info:false,
        paging:true,
