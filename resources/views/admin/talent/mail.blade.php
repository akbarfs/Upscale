                        ...
                        <div class="container-fluid">
                            ...
                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="padding-left:83%;padding-top:3%; margin-bottom:20px">
                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                    <a href="#"><button class="btn btn-danger btn-sm" type="submit" id="search">Cancel</button></a>
                                </div>
                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                    <a href="#"><button class="btn btn-success btn-sm" type="submit" id="search">Sent</button></a>
                                </div>
                            </div>
