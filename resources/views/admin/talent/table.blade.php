	...
	<tbody id="container">
		...
		<tr>
			...
			<td>
				...
				<span class="badge badge-info" data-toggle="tooltip" data-placement="top" title="member">m</span>
				@endif
				<br>
			</td>
			...
			<td>
				<a href="{{url('/admin/talent/detail?id='.$talent->talent_id)}}" class="btn btn-sm btn-primary" target="_blank">
				...
				<a href="{{url('/admin/talent/mail/'.$talent->talent_id)}}" class="btn btn-sm btn-primary" target="_blank">
					<i class="fa fa-envelope"></i>
				</a>

				<!-- <a onclick="return confirm(' Are you sure to delete this?')" href="{{url('/admin/talent/mailSend/'.$talent->talent_id)}}" class="btn btn-sm btn-danger">
