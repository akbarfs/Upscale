                    ...
                    <div class="form-group">
                        <div class="col">
                            <div class="row">
                                ...
                                <input type="text" class="form-control" style="width:147px;margin-left:9px;margin-bottom:9px;" id="client">
                            </div>
                            <div class="row">
                                <label for="Talent">Talent : </label>
                                <input type="text" class="form-control" style="width:147px;margin-left:9px;" id="talent">                                
                            </div>
                        </div>
                    </div>
